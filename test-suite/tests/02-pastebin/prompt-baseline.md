Build a markdown pastebin web app from scratch in this empty project. Stack: Node + Express + better-sqlite3 + vanilla HTML/JS frontend, with `marked` for markdown rendering server-side and `highlight.js` via CDN for code blocks.
